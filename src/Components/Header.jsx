...
const Header = () => {
    ...
    let links = <>
        ...
        {
            user && <>
                <li><NavLink to='/photoalbum'>Photo Album</NavLink></li>
    ...
    return (
        <div className="bg-gradient-to-r from-purple-300 to-indigo-300 rounded-lg py-2">
            <div className="navbar ">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow rounded-box bg-gray-500 text-white font-semibold">
                            {links}
                        </ul>
                    </div>
